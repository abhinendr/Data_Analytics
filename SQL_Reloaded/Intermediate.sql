...
SELECT * FROM EmployeeDemographics AS ED JOIN EmployeeSalary AS ES ON ED.EmployeeID=ES.EmployeeID;

SELECT * FROM EmployeeDemographics AS ED FULL OUTER JOIN EmployeeSalary AS ES ON ED.EmployeeID=ES.EmployeeID;

SELECT * FROM EmployeeDemographics AS ED LEFT JOIN EmployeeSalary AS ES ON ED.EmployeeID=ES.EmployeeID;

SELECT * FROM EmployeeDemographics AS ED RIGHT JOIN EmployeeSalary AS ES ON ED.EmployeeID=ES.EmployeeID;
...
SELECT Firstname + ' ' + Lastname AS FullName from [SQLTUTORIAL].[dbo].[EmployeeDemographics];

SELECT AVG(Age) as AVGAge from SQLTUTORIAL.dbo.EmployeeDemographics;
